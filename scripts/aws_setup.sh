...
# get cudnn
CUDNN_FILE=cudnn-8.0-linux-x64-v5.1-2.tgz
wget https://dl.dropboxusercontent.com/s/dr7r06nyztquub4/${CUDNN_FILE}
tar xvzf ${CUDNN_FILE}
rm ${CUDNN_FILE}
...
# install tensorflow
/mnt/bin/anaconda3/bin/pip install tensorflow-gpu
/mnt/bin/anaconda3/bin/pip install git+git://github.com/tflearn/tflearn.git
